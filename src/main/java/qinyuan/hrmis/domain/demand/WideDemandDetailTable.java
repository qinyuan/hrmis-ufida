...
public class WideDemandDetailTable {

	private int demandId;

	public WideDemandDetailTable(int demandId) {
	...
	private TableData getTd(String id, String text) {
		return new TableData().setId(id).setText(text);
	}

	private TableData getTd(String id, Object text) {
		if (text == null)
			text = "";
		return getTd(id, text.toString());
	}
}
